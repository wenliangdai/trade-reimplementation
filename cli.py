...
def get_args():
    ...
    parser.add_argument('-hdd', '--hidden_size', help='Hidden size', required=False, type=int, default=400)
    ...
    if args['load_embedding']:
        args['hidden'] = 400
        iprint('Using hidden size = 400 for pretrained word embedding (300 + 100)...', msg_type=1)
